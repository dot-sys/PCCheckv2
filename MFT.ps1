...
$usnDump | Where-Object { $_.'Extension' -eq ".rpf" -and $_.'UpdateReasons' -match 'FileDelete' } | Select-Object 'FilePath', 'UpdateTimestamp' | Sort-Object 'UpdateTimestamp' -Descending -Unique | Out-File Deletedrpf.txt -Append -Width 4096
